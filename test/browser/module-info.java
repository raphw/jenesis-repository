/**
 * Tag-gated end-to-end <em>browser</em> tests for the repository web console. They boot the real
 * {@link build.jenesis.repository.ui.Application} on an ephemeral port under the {@code dev} form-login profile, over a
 * throwaway filesystem store, and drive a real Chromium through {@code RemoteWebDriver} against a throwaway
 * {@code selenium/standalone-chrome} container - so the JavaScript layer the {@code ConsoleE2ETest} markup assertions
 * structurally cannot see is exercised as a user would: the htmx lazy-tree expansion swaps a folder's child rows in
 * without a reload, and {@code /js/theme.js} persists a light/dark choice in {@code localStorage} across a reload.
 *
 * <p>The rig is the enterprise console's {@code SeleniumContainer} pattern ported to the free console: a single-container
 * {@code selenium/standalone-chrome} driven through the {@code docker} CLI under host networking (so the browser reaches
 * the ephemeral loopback port the test boots the console on), {@code @Tag("browser")}, and gated through
 * {@link build.jenesis.repository.ui.browser.test.Requirement}: absent a Docker daemon the suite self-skips, but a strict
 * {@code jenesis.test.required} lane fails rather than hide a broken lane.
 *
 * <p>Selenium is adopted as a stable-module-name dependency: the closure is {@code api} + {@code remote-driver} +
 * {@code chrome-driver} + {@code chromium-driver}, every jar a proper JPMS module. {@code selenium-support} is
 * deliberately excluded - its sole extra transitive is the <em>automatic</em>-module Guava, which the strict resolver
 * rejects at compile scope - so its handful of wait helpers are hand-rolled in {@code ConsoleBrowser} instead. Guava and
 * the OpenTelemetry transitives resolve modularly at runtime (pinned below, not {@code requires}d).
 *
 * @jenesis.release 25
 ...
 * @jenesis.pin com.google.auto.service/auto-service-annotations 1.1.1 SHA-256/16a76dd00a2650568447f5d6e3a9e2c809d9a42367d56b45215cfb89731f4d24
 ...
 * @jenesis.pin io.opentelemetry/opentelemetry-api 1.53.0 SHA-256/1991903b9fc76b27f1e6a70a5a97131668fb5f3ac9026178c450d510cbb1bef2
 * @jenesis.pin io.opentelemetry/opentelemetry-common 1.53.0 SHA-256/73a5181dd07e72c4312fadafc8328ad1046a32c050030e3a7b8c16113daad359
 * @jenesis.pin io.opentelemetry/opentelemetry-context 1.53.0 SHA-256/88a780c5bb7b51e7c07071d61403e34f13277d092bf441a5cb49cf2ce9c756e9
 * @jenesis.pin io.opentelemetry/opentelemetry-exporter-logging 1.53.0 SHA-256/acd7b018a6076b1365b3520b6fc1fcf489f3da2f3e1a90ca052cab4dee6c8247
 * @jenesis.pin io.opentelemetry/opentelemetry-sdk 1.53.0 SHA-256/d58721063bca5d612bf1f6dccb883664210999c5aa470c149d1509672f13229c
 * @jenesis.pin io.opentelemetry/opentelemetry-sdk-common 1.53.0 SHA-256/a5d68aca0920aa0dc17b9ecc5510abe4c344e66eae9a4420c992298e4712d3bc
 * @jenesis.pin io.opentelemetry/opentelemetry-sdk-extension-autoconfigure 1.53.0 SHA-256/72becaccfb3d79d91c6486bf4e68f2474a1aa7742934fb675ea077e35a8dc3e1
 * @jenesis.pin io.opentelemetry/opentelemetry-sdk-extension-autoconfigure-spi 1.53.0 SHA-256/e814e63dc2f8cbdf84574b6289eb543b89b06486d03cad1e697b06d802ce27bb
 * @jenesis.pin io.opentelemetry/opentelemetry-sdk-logs 1.53.0 SHA-256/ae1c30170bfe71cb91e2fc0d193c8899aaba5acc90c80a219a4080c2817b9bf8
 * @jenesis.pin io.opentelemetry/opentelemetry-sdk-metrics 1.53.0 SHA-256/3d7dbae6c03be035e7c4dbdd50442741b260be5463fa9aadca1b00af0efddee5
 * @jenesis.pin io.opentelemetry/opentelemetry-sdk-trace 1.53.0 SHA-256/6d26512cbf7434c03a25f3828886f8866f43c683339ba98eaccce74471fcb40a
 ...
 * @jenesis.pin net.bytebuddy/byte-buddy 1.17.6 SHA-256/d26382a839cb26d5c62a0b0f04715bcef55a531f96ac6ce40de452a1c0539e70
 ...
 * @jenesis.pin org.apache.commons/commons-exec 1.5.0 SHA-256/d52d35801747902527826cca30734034e65baa7f36836cc0facf67131025f703
 ...
 * @jenesis.pin org.seleniumhq.selenium.chrome_driver 4.35.0
 * @jenesis.pin org.seleniumhq.selenium.chromium_driver 4.35.0
 * @jenesis.pin org.seleniumhq.selenium.remote_driver 4.35.0
 * @jenesis.pin org.seleniumhq.selenium/selenium-api 4.35.0 SHA-256/dddab2cad799b624220c0bc39567da101cc2cf06c85f309a0706fe8312b5a1e8
 * @jenesis.pin org.seleniumhq.selenium/selenium-chrome-driver 4.35.0 SHA-256/8ad918907fb381d6448b1b0b639a560ad5180131f93947ee2bdaa7f8dfe884f9
 * @jenesis.pin org.seleniumhq.selenium/selenium-chromium-driver 4.35.0 SHA-256/de4239ff9e7e22261c7c16b3a60b5afac8754a0c0ea35d8d2b3cc209508dc616
 * @jenesis.pin org.seleniumhq.selenium/selenium-http 4.35.0 SHA-256/fb964eae6286a5328cb1e941ab841818c448532233e84a7d4b4e00deae04b8ba
 * @jenesis.pin org.seleniumhq.selenium/selenium-json 4.35.0 SHA-256/e2ffa5f99c7d3964be9b5e060faed2ef0ae22bf67294589ed37e2b8451ad9041
 * @jenesis.pin org.seleniumhq.selenium/selenium-manager 4.35.0 SHA-256/84b6c86d0d216fad5c3c7880e7a50a8691f063c532781dc079de4320dc4e61ed
 * @jenesis.pin org.seleniumhq.selenium/selenium-os 4.35.0 SHA-256/cb6b750851e04025d8c3f07b434395176355959ce31e32a95c1ecd2dc6e04ae7
 * @jenesis.pin org.seleniumhq.selenium/selenium-remote-driver 4.35.0 SHA-256/db910d0e24330e386cc153d4192409c80ec152c47ca7d05e5eb90261d8a986ea
 ...
 */
open module build.jenesis.repository.ui.browser.test {
