 ...
 * dependency. An optional cloud backend (S3 / GCS / Azure Blob) is added to the module graph at deploy time
 * and bound here through {@code provides}, with no compile-time dependency from the server.
 */
