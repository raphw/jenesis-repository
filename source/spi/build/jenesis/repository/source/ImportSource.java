 ...
 * none the wiser. Nexus and Artifactory are the built-in ones. Every implementation streams through the same
 * {@link build.jenesis.repository.format.ProxyFormat.Fetcher} the proxy uses, so an import is tested without the network.
 */
