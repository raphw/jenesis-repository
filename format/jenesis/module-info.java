 ...
 * {@link build.jenesis.repository.format.RepositoryFormat} and builds on the shared Java-layout module and the core's
 * format-neutral {@code Publication}. It cross-publishes with the Maven layout over the bridge the shared module
